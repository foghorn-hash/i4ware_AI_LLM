...
let strings = new LocalizedStrings({
  ...
  de: {
    showCaptcha: "Captcha im Registrierungsformular anzeigen",
    disableRegistration: "Registrierung für Nicht-Domänenbesitzer deaktivieren",
    settingUpdated: "Einstellungen aktualisiert",
  },
  pl: {
    showCaptcha: "Pokaż Captcha w formularzu rejestracyjnym",
    disableRegistration: "Wyłącz rejestrację dla osób spoza właścicieli domeny",
    settingUpdated: "Ustawienia zaktualizowane",
  },
});
