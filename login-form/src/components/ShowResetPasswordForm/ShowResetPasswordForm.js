...
let strings = new LocalizedStrings({
  ...
  de: {
    ...
    passwordResetSuccessful: "Passwortrücksetzung erfolgreich.",
    neverShareEmail: "Wir teilen Ihre E-Mail-Adresse niemals mit anderen.",
    passwordStronglyEncrypted: "Das Passwort ist sicher in unserer Datenbank verschlüsselt.",
    submit: "Senden",
...
pl: {
  ...
  tooLong: "Za długi!",
  tooShort: "Za krótki!",
  passwordsDontMatch: "Hasło i potwierdzenie hasła muszą być takie same.",
  passwordResetSuccessful: "Resetowanie hasła zakończone sukcesem.",
  neverShareEmail: "Nigdy nie udostępniamy Twojego adresu e-mail innym osobom.",
  passwordStronglyEncrypted: "Hasło jest bezpiecznie zaszyfrowane i chronione w naszej bazie danych.",
  submit: "Wyślij",
