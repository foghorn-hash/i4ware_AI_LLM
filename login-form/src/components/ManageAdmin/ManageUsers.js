...
let strings = new LocalizedStrings({
  ...
  de: {
    ...
    wantToChangeUserStatus: "Möchten Sie den Status dieses Benutzers wirklich ändern?",
    wantToVerifyUser: "Möchten Sie diesen Benutzer wirklich verifizieren?",
    wantToActivateUser: "Möchten Sie diesen Benutzer wirklich aktivieren?",
    yes: "Ja",
    no: "Nein",
    close: "Schließen",
    actions: "Aktionen",
  ...
  pl: {
    areYouSure: "Czy jesteś pewien/pewna?",
    wantToChangeUserStatus: "Czy na pewno chcesz zmienić status tego użytkownika?",
    wantToVerifyUser: "Czy na pewno chcesz zweryfikować tego użytkownika?",
    wantToActivateUser: "Czy na pewno chcesz aktywować tego użytkownika?",
    yes: "Tak",
    no: "Nie",
    close: "Zamknij",
    actions: "Akcje",
    ...
    columnName: "Nazwa",
    columnVerified: "Zweryfikowany",
    columnDomain: "Domena",
    columnStatus: "Status",
    columnActions: "Akcje",
    nameRequired: "Wymagane jest podanie imienia",
    ...
    passwordsMustMatch: "Hasła muszą być zgodne",
    confirmPasswordRequired: "Potwierdzenie hasła jest wymagane",
    notAssigned: "nieprzydzielona/y",
  },
});
