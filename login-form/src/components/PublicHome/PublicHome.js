...
let strings = new LocalizedStrings({
  en: {
    ...
    copyright: "| i4ware - AI LLM | Copyright © i4ware Software 2004-2024, all rights reserved. | Version 1.0.0"
  },
  fi: {
    ...
    copyright: "| i4ware - AI LLM | Tekijänoikeudet © i4ware Software 2004-2024, kaikki oikeudet pidätetään. | Versio 1.0.0"
  },
  se: {
    ...
    copyright: "| i4ware - AI LLM | Upphovsrätt © i4ware Software 2004-2024, alla rättigheter förbehållna. | Version 1.0.0"
  },
  de: {
    video: "Um dieses Video anzusehen, aktivieren Sie JavaScript und erwägen Sie ein Upgrade auf einen Webbrowser, der",
    web: "HTML5-Videos unterstützt.",
    support: "",
    copyright: "| i4ware - AI LLM | Urheberrecht © i4ware Software 2004-2024, alle Rechte vorbehalten. | Version 1.0.0"
  },
  pl: {
    video: "Um dieses Video anzusehen, aktivieren Sie JavaScript und verwenden Sie einen Webbrowser, der",
    web: "HTML5-Videos unterstützt.",
    support: "",
    copyright: "| i4ware - AI LLM | Urheberrecht © i4ware Software 2004-2024, alle Rechte vorbehalten. | Version 1.0.0"
  },
